...
//OUTPUT FOR BLUETOOTH "framework"//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
/* 
void bluetoothmagic() {
  if (maindataport.available() > 0) {
    input = maindataport.read();
  }
  if (Serial.available() > 0) {
    ...
    messageBuffer += ",";
    messageBuffer += String(azbuff);
    maindataport.print(messageBuffer);
    maindataport.write('\n');
  }
}*/
//conversion so that the Serial library in Processing can read the buffer 
void conversion() {
